...
describe('application tests', () => {
  ...
  it('should render name: Omer Elibol', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Omer Elibol$/);
  });

  it('should render title: BlockChain Developer', () => {
    const element = screen.getByTestId('title');

    checkContent(element, /^Blockchain Developer$/);
  });

  it('should render creator', () => {
    const element = screen.getByTestId('creator');

    checkContent(element, /^Omer Elibol$/, 'https://www.omrelibol.com');
  });

  it('should render link to source code', () => {
    const element = screen.getByTestId('source');

    checkContent(element, /^Source$/, 'https://github.com/cooller458');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/cooller458/');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/%C3%B6mer-elibol-b55771154/'
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:omrelibol4@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Omer Elibol \| Source$/
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Omer Eliboln$/);
